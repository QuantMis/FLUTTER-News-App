...
class FavoriteController extends FxController {
  ...
  void initState() {
    ...
    colorAnimation = ColorTween(begin: Colors.grey.shade400,end: Colors.red).animate(animationController);
    sizeAnimation = TweenSequence(
        <TweenSequenceItem<double>>[
          ...
          TweenSequenceItem<double>(
              tween: Tween<double>(begin: 80, end: 50),
              weight: 50
          )
        ]
    ).animate(animationController);
    paddingAnimation =  TweenSequence(
        <TweenSequenceItem<double>>[
          TweenSequenceItem<double>(
              tween: Tween<double>(begin: 16, end: 1),
              weight: 50
          ),
          TweenSequenceItem<double>(
